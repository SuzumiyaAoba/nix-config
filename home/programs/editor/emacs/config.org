...
(setup proof-general
  ...
  (:with-mode coq-mode
    (:hook (lambda ()
             (setq-default prettify-symbols-alist '(("forall" . "∀")
                                                  ;; ("->"     . "→")
                                                  ("exists" . "∃")
                                                  ;; ("=>"     . "⇒")
                                                  ("False"  . "⊥")
...
(setup meow
  ...
  (defun puni-expand-region-kill-region (arg)
    (interactive "p")
    (puni-expand-region)
  ...
  (defun meow-setup ()
    ...
    (meow-normal-define-key
     ...
     '("d D" . puni-kill-line)
     '("d w" . puni-expand-region-kill-region)
     '("d \"" . puni-mark-list-around-point-kill-region)
     '("d r" . kill-region)
     ...
     '("c w" . (lambda (arg)
                  (interactive "p")
                  (puni-expand-region-kill-region arg)
                  (meow-insert-mode)))
     '("c \"" . (lambda (arg)
                 (interactive "p")
